...
class Joystick(object):
    def __init__(self, dev_fn=config.JOYSTICK_DEVICE_FILE):
        ...
        self.recording = True
        ##追加箇所
        self.button_LB = config.JOYSTICK_LB
        self.button_RB = config.JOYSTICK_RB
        self.lb = 0
        self.rb = 0
    ...
    def poll(self):
        ...
        for e in pygame.event.get():
            ...
            ##追加箇所
            self.lb = self.joystick.get_button(self.button_LB)
            self.rb = self.joystick.get_button(self.button_RB)
