# color_detect.py（READ_INTERVAL/UNKNOWN_THRESH も config.py 参照）
# センサー設定・動作調整パラメータをすべて config.py で一元管理
...
import config  # すべての調整値をここから読み込む
