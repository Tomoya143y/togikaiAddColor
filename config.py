...
THROTTLE_OVERRIDE_TRUE_COLOR = {"green": 90, "white": 30}
# 手動(user)モードでも上書きを適用
THROTTLE_OVERRIDE_APPLY_IN_USER_MODE = False
...
UNKNOWN_THRESH = 10.0     # d がこの値を超えたら "unknown"
...
## 学習済みモデルのパス
model_dir = "models"
model_name = "model_20251022_record_20251022_173657.pth"
